...
class SimpleTrainer():
    def __init__(self, args):
        ...
        if 'DEBUG_LOAD_DATASET' in os.environ:
            self.train_dataset = torch.load('/tmp/train_dataset_simple')
            self.valid_dataset = torch.load('/tmp/valid_dataset_simple')
            self.test_dataset = torch.load('/tmp/test_dataset_simple')
        else:
            ...
            torch.save(self.train_dataset, '/tmp/train_dataset_simple')
            torch.save(self.valid_dataset, '/tmp/valid_dataset_simple')
            torch.save(self.test_dataset, '/tmp/test_dataset_simple')
